...
move_uploaded_file($_FILES['upload']['tmp_name'], "upload/image/".$name);
$full_path = 'http://test-kb-and-gb.mcdir.ru/upload/image/'.$name;
$message = "Файл ".$_FILES['upload']['name']." загружен";
$size=@getimagesize('upload/image/'.$name);
